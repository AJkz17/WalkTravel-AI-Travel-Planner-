...
export default function CurrencyConverter() {
    ...
    return (
        /* 🚨 FIX A: Changed 'overflow-hidden' to 'overflow-visible' so the floating elements can escape! */
        <div className="w-full bg-white border border-slate-200 rounded-3xl shadow-sm overflow-visible relative z-30">
            
            {/* TOP SECTION: Budget Reference Ranges */}
            ...
            {/* BOTTOM SECTION: Currency Calculator */}
            <div className="p-5 bg-slate-50/50 rounded-b-3xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 overflow-visible">
                ...
                <div className="flex flex-wrap items-center gap-3 sm:justify-end overflow-visible">
                    {/* Ringgit Input Field */}
                    <div className="relative rounded-xl border border-slate-200 bg-white shadow-xs max-w-32.5">
                        ...
                        <input 
                            ...
                            className="w-full pl-9 pr-3 py-1.5 rounded-xl text-xs font-bold focus:outline-none focus:ring-1 focus:ring-emerald-500 text-slate-700"
                        />
                    </div>
                    ...
                    <div className="relative overflow-visible" ref={dropdownRef}>
                        ...
                        {isOpen && (
                            /* 🚨 FIX B: Changed positioning to break clear of bounds cleanly ('top-full mt-2') */
                    ...
                    {/* Final Converted Output Display Panel */}
